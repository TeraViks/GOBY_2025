...
public final class Constants {
  ...
  public static final class CraneConstants {
    ...
    public static final SparkUtil.PIDFSlot kElevatorMotorVelocityPIDFSlot = new SparkUtil.PIDFSlot(
      new PIDF(0.75, 0.0, 8.0, 0.0), // TODO: Tune.
      ClosedLoopSlot.kSlot0
    );
    ...
    public static final SparkUtil.Config kElevatorMotorConfig = new SparkUtil.Config(
      ...
      0.0233, // rot -> meters: 12:1 gearbox reduction, 22T sprocket, 1/4" chain link.
      1.0,
      4.0,
      new ArrayList<>() {{
    ...
    public static final PIDF kPivotPIDF = new PIDF(10.5, 0.0, 2.0, 0.0); // TODO: Tune.
    public static final PIDF kElevatorPIDF = new PIDF(9.0, 0.0, 0.0, 0.2); // TODO: Tune
