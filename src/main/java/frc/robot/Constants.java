...
public final class Constants {
  ...
  public static final class OIConstants {
    ...
    public static final int kReadyClimbButton = kLeftJoy;
  ...
  public static final class CraneConstants {
    ...
    public static final Translation2d kPositionL1a =
      new Translation2d(Units.degreesToRadians(15.0), 0.49);
    ...
    public static final Translation2d kPositionLoAlgae =
      new Translation2d(Units.degreesToRadians(-20.0), 0.87);
